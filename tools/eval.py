...
parser.add_argument('--tracker_path', '-p', type=str, default='./hp_search_result',
                    help='tracker result path')
parser.add_argument('--dataset', '-d', type=str, default='UAV123',
                    help='dataset name')
parser.add_argument('--num', '-n', default=1, type=int,
                    help='number of thread to eval')
parser.add_argument('--tracker_prefix', '-t', default='checkpoint_e19',
...
def main():
    ...
    root = os.path.realpath(os.path.join(os.path.dirname(__file__),
                            '/data/study/code/pysot-master01/testing_dataset'))
