...
parser.add_argument('--snapshot', type=str, default='snapshot/checkpoint_e19.pth', help='snapshot of model')
parser.add_argument('--dataset', type=str, default='VOT2018', help='dataset name to eval')
parser.add_argument('--penalty-k', default='0.28,0.3,0.003', type=parse_range)
parser.add_argument('--lr', default='0.325,0.35,0.0025', type=parse_range)
parser.add_argument('--window-influence', default='0.54,0.555,0.0039', type=parse_range)
parser.add_argument('--search-region', default='255,256,8', type=parse_range_int)
parser.add_argument('--config', default='../experiments/siamrpn_r50_l234_dwxcorr_8gpu/config.yaml', type=str)
...
if __name__ == '__main__':
    ...
    dataset_root = os.path.join(cur_dir, '/data/study/code/pysot-master01/testing_dataset', args.dataset)
